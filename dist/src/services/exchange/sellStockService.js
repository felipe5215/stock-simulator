...
exports.sellStocksService = void 0;
...
var sellStocksService = function (order) { return __awaiter(void 0, void 0, void 0, function () {
    var exchangeStock, totalValue, clientBalance, checkAssets;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, getAssetByIdService_1.getAssetByIdService)(order.assetId)];
            case 1:
                exchangeStock = _a.sent();
                totalValue = exchangeStock.value * order.assetQtty;
            ...
            case 3:
                checkAssets = _a.sent();
                if (!checkAssets) {
                    throw new http_exception_1["default"](http_status_codes_1.StatusCodes.NOT_FOUND, 'Investment not found');
                }
                return [4 /*yield*/, prisma
                        ...
                        prisma.holdings.update({
                            ...
                            data: {
                                assetQtty: (checkAssets === null || checkAssets === void 0 ? void 0 : checkAssets.assetQtty) - order.assetQtty
                            }
                        }),
                    ])["catch"](function (err) {
...
exports.sellStocksService = sellStocksService;
//# sourceMappingURL=sellStockService.js.map