...
var depositService = function (depositOrder) { return __awaiter(void 0, void 0, void 0, function () {
    var clientId, amount, lastBalance, deposit;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                clientId = depositOrder.clientId, amount = depositOrder.amount;
                return [4 /*yield*/, (0, checkBalance_1.checkBalance)(clientId)];
            case 1:
                lastBalance = _a.sent();
