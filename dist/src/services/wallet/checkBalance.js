...
var checkBalance = function (clientId) { return __awaiter(void 0, void 0, void 0, function () {
    var clientCurrInfo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma.wallet
                    .findUnique({ where: { clientId: clientId } })
            ...
            case 1:
                clientCurrInfo = _a.sent();
                return [2 /*return*/, clientCurrInfo];
        }
    });
}); };
